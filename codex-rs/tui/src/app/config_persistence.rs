...
impl App {
    ...
    pub(super) fn on_update_reasoning_effort(&mut self, effort: Option<ReasoningEffortConfig>) {
        ...
        self.on_update_active_reasoning_effort(effort);
    }

    pub(super) fn on_update_active_reasoning_effort(
        &mut self,
    ...
    pub(super) fn on_update_active_plan_mode_reasoning_effort(
        &mut self,
        effort: Option<ReasoningEffortConfig>,
    ) {
...
mod tests {
    ...
    #[tokio::test]
    async fn active_reasoning_effort_does_not_change_new_task_default() {
        let mut app = make_test_app().await;
        app.config.model_reasoning_effort = Some(ReasoningEffortConfig::High);
        app.chat_widget
            .set_reasoning_effort(Some(ReasoningEffortConfig::High));

        app.on_update_active_reasoning_effort(Some(ReasoningEffortConfig::Ultra));
        ...
        assert_eq!(
            app.fresh_session_config().model_reasoning_effort,
            Some(ReasoningEffortConfig::High)
        );
    }

    #[tokio::test]
    async fn active_plan_reasoning_effort_does_not_change_new_task_default() {
        let mut app = make_test_app().await;
        ...
        app.on_update_active_plan_mode_reasoning_effort(Some(ReasoningEffortConfig::Ultra));
        ...
        assert_eq!(
            app.fresh_session_config().plan_mode_reasoning_effort,
            Some(ReasoningEffortConfig::High)
        );
    }
